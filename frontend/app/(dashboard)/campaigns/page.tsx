            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800">
              {campaigns.map((c) => (
                ...
                >
                  ...
                  <td className="px-5 py-4 text-gray-400 dark:text-gray-500 text-xs hidden lg:table-cell">
                    {fmt(c.scheduled_at)}
                  </td>
                  <td className="px-5 py-4">
                    ...
                    <div className="flex items-center justify-end gap-2">
                      {(c.status === "draft" || c.status === "scheduled") && (
                        <button
                          ...
                          className="text-xs font-semibold px-3 py-1.5 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 transition-all"
                        >
                          Start
                        </button>
                      )}
        ...
        <form onSubmit={handleCreate} className="space-y-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) =>
                setForm({ ...form, lead_group_id: e.target.value })
              }
              className={INPUT}
            >
