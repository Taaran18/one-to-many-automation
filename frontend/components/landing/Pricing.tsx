...
const PLANS = [
  {
    ...
    price:       'Free',
    sub:         'Forever free',
    desc:        'Perfect for small teams testing WhatsApp and Email outreach.',
    highlight:   false,
    badge:       null,
    features: [
      '100 messages / month',
  ...
  },
  {
    ...
    price:       '₹999',
    sub:         'per month',
    desc:        'For growing businesses that need multi-channel automation at scale.',
    highlight:   true,
    badge:       'Most Popular',
    features: [
      ...
      'Unlimited campaigns',
      '5,000 leads',
      'WhatsApp QR + Meta Business API',
      'Email campaigns (HTML + plain text)',
  ...
  },
  {
    ...
    price:       '₹2,999',
    sub:         'per month',
    desc:        'Enterprise-grade multi-channel automation for high-volume senders.',
    highlight:   false,
    badge:       null,
    features: [
      'Unlimited messages',
